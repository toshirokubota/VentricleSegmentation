...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	if (nlhs >= 1)
	{
		...
		for (int i = 0; i < particles.size(); ++i)
		{
			...
			SetData2(F, i, 7, dims[0], dims[1], (int)p->descendents.size());
		}
